...
osThreadId rs232ServerHandle;
osThreadId rs232ClientHandle;
...
//    init_comm_obj(TASK_GATE_KEEPER, &gateKeeperHandle);
    initialize_port_service(PORT_QUEUE_SEND_MODE);
...
/* USER CODE BEGIN Header_gateKeeperTask */
/**
  * @brief  Function implementing the gateKeeper thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_gateKeeperTask */
